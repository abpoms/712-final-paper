...
distributed processing required for computing on array-like data.
...
collections abstraction on top of Legion is

\subsubsection{K Nearest Neighbors Implementation}

\begin{figure*}
\label{fig:knn}\includegraphics[width=0.45\textwidth]{figures/knn}
\end{figure*}
...
\begin{figure*}
\label{fig:scaling}\includegraphics[width=0.45\textwidth]{figures/scaling}
\end{figure*}
