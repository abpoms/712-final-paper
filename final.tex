...
\texit{transformation} operations on immutable distributed collections (called
\texit{RDDs}) that source their data from some stable storage (such as
...
of stage, which they call a Result Stage, consists of series of point-wise
operations (such as map, filter, flatmap, etc.). The second type of stage,
which they call a Shuffle Stage, is composed of mapper nodes which write key
...
information requires acknowledging this representation.
